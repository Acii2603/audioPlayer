...
public class User {
    ...
    public User(final String username, final int age, final String city) {
        ...
        lastSearched = false;
        status = true;
        currentPage = new HomePage(username, getLikedSongs(), getFollowedPlaylists());
    }
    ...
    public String select(final int itemNumber) {
        ...
        if ((selected instanceof ArtistList) || (selected instanceof HostFile)) {
    ...
    public String load() {
        ...
        String lastType = searchBar.getLastSearchType();
    ...
    public void simulateTime(final int time) {
        player.simulatePlayer(time, status);
    }
