...
public final class Player {
    ...
    public static PlayerSource createSource(final String type,
        ...
        if ("song".equals(type)) {
            ...
            return new PlayerSource(Enums.PlayerSourceType.ARTIST, (AudioCollection) entry);
        } else if ("host".equals(type)) {
            return new PlayerSource(Enums.PlayerSourceType.HOST, (AudioCollection) entry);
     ...
     * @param time the time
     */
    public void simulatePlayer(final int time, final boolean online) {
